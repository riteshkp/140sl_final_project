...
# Load data
reddit_comments <- read.csv('intel_clean_comments.csv')
reddit_posts <- read.csv('intel_reddit_clean_posts.csv')
google <- read.csv('intel_google_trend.csv')[-c(1:6),]
prices <- read.csv('INTC.csv')
